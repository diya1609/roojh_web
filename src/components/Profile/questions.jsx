...
import decorativeImage from '../img_section/Group 1000004690.png'

export default function Questions({
  stepCounterText = "Step 4",
  healthDataText = "You can ask questions, and receive personalized health guidance",
  medicalFilesDescription = "Get personalized answers and see beautiful visual representation of your health vitals",
  ...props
}) {
  return (
